...
public class Configuration {
	...
	static {
		...
		RENDER_DISTANCE = clientBuilder.comment("How close the player has to be to see the beam. Increased limit for custom distance rendering.").defineInRange("render_distance", 32D, 0D, 64D);
